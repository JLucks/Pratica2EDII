 ...
 * @author Jorge
 */
public class AddDocumento extends javax.swing.JFrame {

    /**
     * Creates new form AddDocumento
     */
    public AddDocumento() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddDocumento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddDocumento().setVisible(true);
            }
        });
    }
